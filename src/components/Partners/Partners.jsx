      ...
      <div className="w-11/12 xl:w-2/3 lg:w-2/3 md:w-2/3 mx-auto">
        <div className=" sm:mb-10 mb-16">
          ...
          <p className="text-base md:text-lg lg:text-xl text-center text-gray-600 font-normal xl:w-10/12 xl:mx-auto">
            At Mini Product Hunt, we take pride in collaborating with some of
            the most innovative and sought-after brands in the tech industry.
            Our partnerships allow us to bring cutting-edge products to our
            community, ensuring users discover high-quality, trend-setting
            innovations.
          </p>
        </div>
